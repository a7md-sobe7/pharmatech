...
export class StrengthNormalizer {
   ...
   */
  public static normalize(value?: number, unit?: string): NormalizedStrength {
   ...
   */
  public static calculateStrengthSimilarity(
    targetVal?: number, 
    targetUnit?: string, 
    candidateVal?: number, 
    candidateUnit?: string
  ): { score: number; percentage: number; explanation: string } {
    ...
    if (maxVal === 0) return { score: 1.0, percentage: 100, explanation: 'Matching strengths.' };
