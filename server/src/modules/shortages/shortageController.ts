...
export class ShortageController {
   ...
   */
  public static async getShortageStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  public static async createShortage(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const {
        medicineName,
        medicineNameAr,
   ...
   */
  public static async updateShortage(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
      const {
        currentQuantity,
      ...
      if (!item) throw new AppError('Shortage entry not found.', 404, 'NOT_FOUND');
   ...
   */
  public static async deleteShortage(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
