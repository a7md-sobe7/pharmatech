...
const PharmacyInventorySchema = new Schema<IPharmacyInventoryDoc>({
...
export const PharmacyInventory = mongoose.model<IPharmacyInventoryDoc>('PharmacyInventory', PharmacyInventorySchema);
